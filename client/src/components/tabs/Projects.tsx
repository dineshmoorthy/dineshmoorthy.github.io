...
const getProjectTypeColors = (type: string) => {
  ...
  if (projectType.includes('machine learning') || projectType.includes('ai') || projectType.includes('ml')) {
    return {
  ...
  return (
    <div className="animate-fade-in">
      <div className="flex items-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Featured Projects</h2>
      </div>
      
      {/* Decorative elements */}
      <div className="relative mb-10">
        <div className="absolute -top-16 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-16 left-0 w-32 h-32 bg-violet-500/10 rounded-full blur-3xl"></div>
      </div>
            ...
            >
              ...
              <CardContent className={`p-6 bg-gradient-to-br ${colors.softGradient} dark:${colors.darkGradient}`}>
                  ...
                  {project.skills.map((skill, index) => (
                    <Badge 
                      ...
                      className={`bg-white/80 dark:bg-gray-800/80 text-gray-800 dark:text-gray-200 text-xs font-normal py-1 px-2 rounded-md transition-all duration-300 ${
                        hoverSkill === skill ? 'bg-blue-100 dark:bg-blue-900/30 border-blue-300 dark:border-blue-700 scale-105' : 'border-gray-200 dark:border-gray-700'
                      }`}
                ...
                <div className="flex justify-between items-center pt-2 border-t border-gray-200 dark:border-gray-700">
                  ...
                  >
                    <Button variant="ghost" size="sm" className="group text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20">
                      <i className="fas fa-globe mr-2 group-hover:scale-110 transition-transform duration-300"></i>
                      <span>Live Demo</span>
                    </Button>
                  </a>
